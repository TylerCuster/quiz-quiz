...
window.angular.module('quizquiz.controllers', ['quizquiz.controllers.header', 'quizquiz.controllers.create', 'quizquiz.controllers.list', 'quizquiz.controllers.quiz']);
